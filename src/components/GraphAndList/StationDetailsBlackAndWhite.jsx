...
import whiteGasStation from "../../../public/assets/white-gas-station-svgrepo-com.png";

function StationDetailsBlackAndWhite() {
  ...
  return (
    <div className="relative z-[1] mb-[20px] w-[1200px] rounded-[16px] h-[193px] bg-white opacity-100">
      <i className="absolute top-[50px] left-[20px] w-[12px] h-[12px] bg-[#B9CDE2] opacity-100 rounded-full"></i>
      <img
        src={whiteGasStation}
        alt="white-gas-station"
        className="absolute top-[29px] left-[40px] w-[39px] h-[32px] bg-transparent bg-white-gas-station bg-cover bg-no-repeat"
      />
...
export default StationDetailsBlackAndWhite;
